// Safar DZ Design System — Tokens: Typography
// Mirrors font-family + utility classes in ../tokens.css.
//
// Fonts:
// - Cascadia Mono (substituted with JetBrains Mono, a free Google Font —
//   Cascadia Mono itself isn't installed/available, see docs/DESIGN_SYSTEM.md)
//   → primary UI: body, buttons, captions, controls
// - Pristine Script (self-hosted, assets/fonts/PristineScript.ttf) → brand headings
// - Kumquat (self-hosted, assets/fonts/Kumquat.otf) → special adventure / experience titles

export const fontFamily = {
  ui: "'JetBrains Mono', 'Cascadia Mono', ui-monospace, monospace",
